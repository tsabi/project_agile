...
class Task(models.Model):
    ...
    def _read_workflow_stage_ids(self, stages, domain, order):
        ...
        project.workflow_id.state_ids.sorted(key=lambda s: s.sequence)
        stage_ids = [x.stage_id.id for x in project.workflow_id.state_ids]
    ...
    @api.multi
    def _confirm_stage_change(self, user_id, stage_id, message):
        self.ensure_one()
