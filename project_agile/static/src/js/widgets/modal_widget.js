...
odoo.define('project_agile.widget.modal', function (require) {
    ...
    const Many2ManyTags = require('project_agile.widget.many2many_tags').Many2ManyTags;
    ...
    const TaskStageConfirmationModal = ModalWidget.extend({
        ...
        submit(confirmation, form) {
            ...
            data.session.rpc(`/agile/web/data/task/${taskId}/confirm_stage_change`, payload).then(result => {
                if (typeof this.afterHook === "function") {
