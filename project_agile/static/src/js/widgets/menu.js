...
odoo.define('project_agile.menu', function (require) {
    "use strict";
    ...
    var AgileMenuItem = AgileContainerWidget.extend({
        _name: "AgileMenuItem",
        template: "project.agile.menu.menuitem",
        init(parent, options) {
            this._super(parent, options);
            Object.assign(this, options);
        },
    ...
    var AgileHorizontalMenuItem = AgileMenuItem.extend({
        ...
        template: "project.agile.menu.menuitem.horisontal",
        start() {
    ...
    var AgileVerticalMenuItem = AgileMenuItem.extend({
        ...
        init(parent, options) {
            if (options.children && options.children.length > 0) {
                this.template = "project.agile.menu.category";
            }
            if (options.parent) {
                this.template = "project.agile.menu.subitem"
            }
            this._super(parent, options);
        },
        start() {
    ...
    var AgileVerticalFromTopMenuItem = AgileMenuItem.extend({
        ...
        template: "project.agile.menu.menuitem.overflow",
        init(parent, options) {
            if (options.children && options.children.length > 0) {
                this.template = "project.agile.menu.category";
            }
