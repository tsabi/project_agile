...
odoo.define('project_agile.BaseWidgets', function (require) {
    ...
    var AgileBaseWidget = Widget.extend(AgileMixins.RequireMixin, {
        ...
        // Overriding method so that handler doesn't always call stop_propagation.
                            ...
                            return new Proxy(() => {
                                ...
                                apply: function (trapTarget, thisArg, argumentList) {
                                    return new Promise(function (resolve, reject) {
                                        widget.dataset._model.call(key, [[model.id], ...argumentList], {context: widget.dataset.get_context().eval()})
