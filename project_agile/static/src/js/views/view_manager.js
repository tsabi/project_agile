...
odoo.define('project_agile.view_manager', function (require) {
    "use strict";
    ...
    var TaskView = require('project_agile.view.task').TaskView;
    var bus = require('project_agile.core').bus;


    // Key is used to define what string should be used in hash_service for ViewManager
    var ViewManager = AgileBaseWidget.extend({
        key: "view",
        template: "project.agile.view_manager",
        custom_events: {
        ...
        set_view(view_name) {
            if (this.view_registry.get(view_name)) {
                ...
                throw new Error("View " + view_name + " does not exist!");
            }
        },
        rerender_view() {
