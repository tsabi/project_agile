...
class Sprint(models.Model):
    ...
    def _get_task_ids_domain(self):
        domain = []
        if 'filter_tasks_by_project' in self.env.context and self.env.context['filter_tasks_by_project']:
            domain.append(('project_id', 'in', self.env.context['filter_tasks_by_project']))
        return domain
